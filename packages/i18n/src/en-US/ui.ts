  ...
  canvas: {
    ...
    workflow: {
      variables: {
        title: 'User Input',
        tooltip: 'User Input',
        addTitle: 'Add Input Item',
        editTitle: 'Edit Input Item',
        addVariableTitle: 'Add {{type}} Variable',
        editVariableTitle: 'Edit {{type}} Input Item',
        name: 'Name',
        value: 'Content',
        ...
        loadError: 'Failed to load input items',
        saveError: 'Failed to save input items',
        saveSuccess: 'input items saved successfully',
        updateSuccess: 'input items updated successfully',
        deleteConfirm: 'Delete this variable?',
        empty: 'No input items defined',
        addVariable: 'Add',
        variableType: 'Input Item Type',
        required: 'Required',
