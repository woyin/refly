const translations = {
  ...
  canvas: {
    ...
    nodeTypes: {
      ...
      extensionWeblinkSelection: '网页选中内容 {{content}}',
      documentCursorSelection: '文档光标选中内容 {{content}}',
      documentBeforeCursorSelection: '文档光标前内容 {{content}}',
      documentAfterCursorSelection: '文档光标后内容 {{content}}',
    },
    presetScenarios: {
      title: '预设场景',
      generatePPT: '生成 PPT',
