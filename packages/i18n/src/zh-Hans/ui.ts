const translations = {
  ...
  landingPage: {
    ...
    messageText: 'v0.8.0 发布：多模态 Agent 正式发布 🚀',
    simpleMessageText: 'v0.8.0: 多模态 Agent 正式发布 🚀',
    tryForFree: '开始使用',
    tryItNow: '立即体验',
    creationEngine: '创作引擎',
    addToChrome: '安装浏览器插件',
  ...
  settings: {
    ...
    modelConfig: {
      ...
      default: '默认分组',
      providerMode: '配置模式',
      providerModeDescription: '自定义模型将优先使用您配置的模型，全局模型将使用 Refly 提供的模型',
      custom: '自定义',
      global: '全局',
      syncSuccessfully: 'providerMode 配置同步更新成功！',
      syncFailed: 'providerMode 配置同步更新失败，请重试！',
      description: '描述',
