  ...
  return (
    ...
    >
      ...
      <div className="w-full h-[calc(100vh-16px)] relative flex flex-col overflow-hidden border-[1px] border-solid border-refly-Card-Border rounded-xl shadow-sm">
        ...
        {isPilotOpen ? (
          <div className="absolute bottom-2 left-1/2 transform -translate-x-1/2 z-20 shadow-sm rounded-[20px] w-[568px] border border-solid border-gray-100 dark:border-gray-800">
          ...
          <Button
            type="default"
            className="absolute bottom-4 left-1/2 -translate-x-1/2 z-20 bg-white dark:bg-neutral-900/95 border border-neutral-200 dark:border-neutral-800 rounded-full h-14 px-4 shadow-sm hover:shadow transition-colors flex items-center gap-3 w-[280px] max-w-[92vw]"
