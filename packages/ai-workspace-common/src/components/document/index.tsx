...
const StatusBar = memo(
  ({ docId }: { docId: string }) => {
    ...
    return (
      <div className="w-full h-11 px-3 py-2 border-x-0 border-t-0 border-b-[1px] border-solid border-refly-Card-Border flex flex-row items-center justify-between">
