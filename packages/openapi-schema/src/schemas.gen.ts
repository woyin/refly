...
export const ResourceFieldSchema = {
  type: 'object',
  required: ['fieldPath', 'type', 'isArray'],
  properties: {
    fieldPath: {
      type: 'string',
...
export const HandlerRequestUserSchema = {
  type: 'object',
  required: ['uid'],
  properties: {
    uid: {
...
export const HandlerRequestSchema = {
  ...
  properties: {
    ...
    user: {
      $ref: '#/components/schemas/HandlerRequestUser',
    },
    metadata: {
      type: 'object',
      additionalProperties: true,
...
export const UploadResultSchema = {
  type: 'object',
  required: ['localPath', 'storageKey', 'entityId', 'fileId', 'url', 'resourceType'],
  properties: {
    localPath: {
      type: 'string',
...
export const HandlerContextSchema = {
  ...
  properties: {
    ...
    inputResourceFields: {
      ...
      description: 'Input resource fields configuration',
    },
    outputResourceFields: {
      type: 'array',
      items: {
      ...
      description: 'Output resource fields configuration',
    },
    startTime: {
      type: 'number',
...
export const HandlerConfigSchema = {
  ...
  properties: {
    ...
    inputResourceFields: {
      ...
      description: 'Input resource fields',
    },
    outputResourceFields: {
      type: 'array',
      items: {
      ...
      description: 'Output resource fields',
    },
    timeout: {
      type: 'number',
