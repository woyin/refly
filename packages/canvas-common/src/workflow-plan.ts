  ...
  products: z
    .array(
      z.object({
        ...
        intermediate: z.boolean().describe('Whether this product is intermediate'),
      }),
    )
...
export const generateCanvasDataFromWorkflowPlan = (_workflowPlan: WorkflowPlan): RawCanvasData => {
  return {
    nodes: [],
    edges: [],
  };
